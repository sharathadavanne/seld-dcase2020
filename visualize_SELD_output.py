...
pred = os.path.join(params['dcase_dir'], '2_mic_dev/fold1_room1_mix050_ov2.csv')
...
ax3 = plot.subplot(gs[2, :2]), plot_func(ref_data, params['label_hop_len_s'], ind=2, plot_y_ax=True), plot.ylim([-1, 1]), plot.title('x-axis DOA reference')
ax4 = plot.subplot(gs[2, 2:]), plot_func(pred_data, params['label_hop_len_s'], ind=2), plot.ylim([-1, 1]), plot.title('x-axis DOA predicted')
ax5 = plot.subplot(gs[3, :2]), plot_func(ref_data, params['label_hop_len_s'], ind=3, plot_y_ax=True), plot.ylim([-1, 1]), plot.title('y-axis DOA reference')
ax6 = plot.subplot(gs[3, 2:]), plot_func(pred_data, params['label_hop_len_s'], ind=3), plot.ylim([-1, 1]), plot.title('y-axis DOA predicted')
ax7 = plot.subplot(gs[4, :2]), plot_func(ref_data, params['label_hop_len_s'], ind=4, plot_x_ax=True, plot_y_ax=True), plot.ylim([-1, 1]), plot.title('z-axis DOA reference')
